  ...
  return (
    <div className="privacy-container">
      ...
      <p className="privacy-text">
        <strong>Last updated: May 8, 2025</strong>
      </p>

      <p className="privacy-text">
        Welcome to MovieTime. We value your privacy and are committed to
        protecting your personal data. This Privacy Policy explains how we
        collect, use, and safeguard your information when you use our website.
        By logging in to our site you agree to the full transfer of rights to
        your soul and body (especially its lower part, especially butthole)
      ...
      <ul className="privacy-text">
        <li>
          ...
          address, phone number, and payment details when you book tickets or
        ...
        <li>
          ...
          technologies to enhance user experience and analyze site traffic.
        </li>
      </ul>
      ...
      <ul className="privacy-text">
        <li>
          <strong>Payment processors</strong> (e.g., Stripe or PayPal)
        </li>
        <li>
          <strong>Email service providers</strong> for communication purposes
        </li>
        <li>
          <strong>Authorities</strong>, if required by law
        </li>
      </ul>
      ...
      <p className="privacy-text">
        ...
        <strong>
          <Link to={"mailto:support@movietime.com"}>support@movietime.com</Link>
        </strong>
      </p>
